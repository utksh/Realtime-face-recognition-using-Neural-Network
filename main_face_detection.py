            ...
            if (c % timeF == 0):
                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        # Classify according to the saved model in create_classifier.py
                        ...
                        for H_i in HumanNames:
                            if HumanNames[best_class_indices[0]] == H_i:
                                ...
                                cv2.putText(frame, '{}'.format(result_names), (text_x, text_y), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0), thickness=1, lineType=2)
                        cv2.imwrite("./classified_frames_output/{}.jpg".format(time.time()), frame)
                else:
                    print('Alignment Error. PLEASE KEEP ALL THE FACES IN THE FRAME')
